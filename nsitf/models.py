...
class City(models.Model):
    state = models.ForeignKey(State, models.SET_NULL,
...
class Employers(models.Model):
    ...
    state=models.ForeignKey(State, on_delete=models.SET_NULL, null=True)
    #local_council=models.ForeignKey(Local_Government, on_delete=models.SET_NULL, null=True)
    ...
    # entered_on = models.DateTimeField(auto_now_add=True, editable=False,\
    # null=True, blank=True)
    entred_by = models.ForeignKey(User,models.SET_NULL,related_name='changeby',\
    blank=True,null=True,unique=False)
    
    notes = models.TextField(blank=True, null=True)
    region = models.ForeignKey(Regions, on_delete=models.SET_NULL,blank=True,null=True,unique=False)
    # branch = models.ForeignKey(Branches, on_delete=models.SET_NULL,blank=True,null=True,unique=False)
